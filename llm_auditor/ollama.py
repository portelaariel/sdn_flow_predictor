...
def explanation_prompt(record: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "deliberado e não representa falha. Um agente que não venceu o claim "
        "deve abster-se de executar, evitando duplicidade. "
...
def evaluation_prompt(evidence: Dict[str, Any]) -> str:
    return (
        ...
        "execução é intencional e a eficácia operacional é NOT_APPLICABLE. "
        "Somente um domínio pode vencer o claim; os demais devem abster-se. "
